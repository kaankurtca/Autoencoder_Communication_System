...
# farklı Eb/No oranlarında eğitilerek sonuçlar incelenecek.
...
for i in SNR_dbS:
    ...
    EbNo_train = 10**(i/10)  # dB'nin gerçek Eb/No değerine dönüştürülmesi
